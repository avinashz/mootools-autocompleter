/*
aCompleter: A MooTools plugin for AJAX autocomplete

Author:

Expert Developer (http://www.xpertdeveloper.com)

copyrights:
  - [Expert Developer] (http://www.xpertdeveloper.com)

licenses:
  - [MIT License](http://www.xpertdeveloper.com/license.txt)
*/
...
var aCompleter = new Class({
	...
	show_loading_image: function()
	{
		...
		var top_offset = (parseInt(document.id('completer_loading_div').getStyle('height'))/2) + parseInt(document.id(this.options.text_box_id).getStyle('padding-top'));

		var left = parseInt(points.right)-parseInt(25);
		var top = parseInt(points.top)+parseInt(top_offset);
